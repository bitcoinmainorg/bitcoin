...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1571253158, 861825651, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000000065ccad4b9bb9ae3b66d074dd7b812f66f18d25e915c59bbede78c45"));
        assert(genesis.hashMerkleRoot == uint256S("0x50fe8879c0bfc688289c0504732b4b14cafb86b61f0afdc0601f2c8ea189ee81"));
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0000000000000000000000000000000000000000000000000000000100010001"); // 1580000

        pchMessageStart[0] = 0x0a; //0x0b
        pchMessageStart[1] = 0x10; //0x12
        pchMessageStart[2] = 0x08; //0x09
        pchMessageStart[3] = 0x05; //0x06
        nDefaultPort = 19333;
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        pchMessageStart[0] = 0xf0;  //0xfa
        pchMessageStart[1] = 0xbe;  //0xbf
        pchMessageStart[2] = 0xb4;  //0xb5
        pchMessageStart[3] = 0xd0;  //0xda
        nDefaultPort = 19444;
        nPruneAfterHeight = 1000;
